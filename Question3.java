...
public class Question3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] choice = getResources().getStringArray(R.array.q3ans);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //changed shared pref keys on each page
                editor.putString("reply3", (String)radioButton.getText() );
                editor.putInt("score3", score[radioId]);
                editor.apply();
