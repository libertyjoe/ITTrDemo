...
public class Question10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] choice = getResources().getStringArray(R.array.q10ans);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString("reply10", (String)radioButton.getText() );
                editor.putInt("score10", score[radioId]);
                editor.apply();




                startActivity(new Intent(Question10.this, Summary3.class));
